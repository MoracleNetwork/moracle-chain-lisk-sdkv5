...
import CreateCustomTokenDialog from './components/dialogs/CreateCustomTokenDialog';
import CreateCDPDialog from "./components/dialogs/CreateCDPDialog";
				...
				<Router>
					<AppBar position="static">
						<Toolbar>
							...
							<Typography variant="h6">MUSD and WLSK App</Typography>
					...
					>
						<SpeedDialAction
							...
							tooltipTitle={"Create CDP"}
							onClick={() => {
								setOpenSpeedDial(false);
								setOpenDialog("CreateCDPDialog")
							}}
						/>
						<SpeedDialAction
							key={'Create Token'}
							icon={<AddPhotoAlternateIcon />}
							tooltipTitle={'Create Token'}
							onClick={() => {
								setOpenSpeedDial(false);
					...
					<CreateCDPDialog
						open={openDialog === 'CreateCDPDialog'}
						handleClose={() => {
							setOpenDialog(null);
						}}
					/>
