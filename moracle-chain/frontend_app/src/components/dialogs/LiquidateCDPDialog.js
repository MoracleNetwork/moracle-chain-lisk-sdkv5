    ...
    <Fragment>
      <Dialog open={props.open} onBackdropClick={props.handleClose}>
        <DialogTitle id="alert-dialog-title">
          {"Liquidate Collateralized Debt Position"}
        </DialogTitle>
        <DialogContent>
          ...
          <p>Submit this modal to attempt to liquidate this position.</p>
        ...
        <DialogActions>
          <Button onClick={handleSend}>Attempt to liquidate</Button>
        </DialogActions>
      </Dialog>
    </Fragment>
  );
